-- $Id: test_bgs_ap.adb.adb,v 1.4 2008/11/23 21:33:20 baker Exp baker $
...
procedure Test_BGS_AP is
   ...
   Aperiodic_Policy : aliased Threads.Sched_BGS.Object;
   ...
   Test_Name : constant String := "test_bgs_ap";
